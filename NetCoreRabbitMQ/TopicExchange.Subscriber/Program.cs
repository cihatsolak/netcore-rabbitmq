...
namespace TopicExchange.Subscriber
{
    class Program
    {
        ...
        /// Publisher tarafında kuyruk tanımlanmadı. Subscriber ihtiyacı olan route key'e göre exchange'den mesajları alacak.
        /// </summary>
        ...
        static void Main(string[] args)
        {
            ...
            channel.QueueBind(
                ...
                exchange: "vehicles-topic", //Publisherda oluşturulan exchange ismi
                routingKey: "*.Golf.*" //routeKey mesajları filtereleme için kullanılır. Bind ettiğim kuyruk ile birlikte exchange'e gidip routeKey'ime uyan mesajları alacağım.
                );
